...
if (isset($_SESSION["Cart"])) {
	...
	if ($result->num_rows > 0) {
		...
		echo "<button type='submit' style='float: right; background-color: rgb(0, 132, 255); color: white; font-weight: 500; font-size: 18px; height: 50px; padding: 0 30px; border: none; border-radius: 5px; cursor: pointer;'>Checkout</button>";
		echo "</form></p>";		
	}
	else {
